...
start:
	...
	xor ax,ax
	mov ds,ax
	mov es,ax	; these three will clear the ax,ds and es registers
...
times (510 - ($ - $$)) db 0x00 	;set 512 bytes $$ are 2 bytes, this tells the bios that this file contain bootloader components
